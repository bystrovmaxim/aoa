...
- Собирает содержимое всех найденных файлов в один файл code.ver в той же папке.
...
Параметры командной строки:
    ...
    --output (-o):       Имя выходного файла (по умолчанию: code.ver)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '-o', '--output',
        default='code.ver',
        help='Имя выходного файла (по умолчанию: code.ver).',
    )
