# src/src/maxitor/samples/support/entities/__init__.py
from __future__ import annotations

from maxitor.samples.support.entities.support_comment_thread_stub import SupportCommentThreadStubEntity
from maxitor.samples.support.entities.support_mesh_ticket_observer import SupportTicketParticipantPairEntity
