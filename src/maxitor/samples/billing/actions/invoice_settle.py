...
from maxitor.samples.billing.resources.ledger_archive import LedgerArchiveService, LedgerArchiveServiceResource
from maxitor.samples.billing.resources.payment_gateway import PaymentGateway, PaymentGatewayResource
from maxitor.samples.billing.resources.tax_quote import TaxQuoteService, TaxQuoteServiceResource
