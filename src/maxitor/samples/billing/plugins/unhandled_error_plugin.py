# src/maxitor/samples/billing/plugins/unhandled_error_plugin.py
from __future__ import annotations

from typing import Any

from action_machine.intents.plugins.events import UnhandledErrorEvent
from action_machine.intents.plugins.on_decorator import on
from action_machine.intents.plugins.plugin import Plugin


class BillingUnhandledErrorSwallowPlugin(Plugin):
