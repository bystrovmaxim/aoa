...
"""``python -m maxitor`` builds the sample ``NodeGraphCoordinator`` and prints graph size."""

from __future__ import annotations

from maxitor.samples.node_build import build_sample_node_graph_coordinator
