# src/action_machine/model/graph_model/aspect_graph_node_locator.py
"""
AspectGraphNodeLocator — locate regular-aspect graph nodes for one action type.
"""
...
class AspectGraphNodeLocator:
    """Locate regular-aspect graph nodes for a single target type."""
