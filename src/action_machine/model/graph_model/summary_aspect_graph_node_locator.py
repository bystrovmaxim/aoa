...
from action_machine.model.graph_model.summary_aspect_graph_node import (
...
class SummaryAspectGraphNodeLocator:
    ...
    def locate(target_type: type | None) -> list[BaseGraphNode[Any]]:
        ...
        summary_aspect_nodes: list[BaseGraphNode[Any]] = [
            SummaryAspectGraphNode(aspect_callable)
            for aspect_callable in summary_aspect_callables
        ]
        return summary_aspect_nodes
