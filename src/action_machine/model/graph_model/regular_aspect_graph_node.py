...
class RegularAspectGraphNode(BaseGraphNode[Callable[..., Any]]):
    ...
    def __init__(self, aspect_func: Callable[..., Any], _action_cls: type[Any]) -> None:
        ...
        object.__setattr__(self, "checkers", CheckerGraphEdge.get_checker_edges(aspect_func, _action_cls, node_id, RegularAspectGraphNode.NODE_TYPE))
        object.__setattr__(self, "required_context", RequiredContextGraphEdge.get_required_context_edges(aspect_func, _action_cls, node_id, RegularAspectGraphNode.NODE_TYPE))
