...
minimal output contract is enough. Pair with
...
class ResultStub(BaseResult):
    ...
    INVARIANTS: Single described field satisfies described-fields tooling expectations.
    AI-CORE-END
    """

    ok: bool = Field(default=True, description="Stub success flag for placeholder results.")
