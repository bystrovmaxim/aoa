...
class CheckRoles:
    ...
    Проверка:
        Декоратор проверяет, что декорируемый класс наследует RoleGateHost.
        Если класс не наследует RoleGateHost, возникает TypeError с сообщением,
        предлагающим унаследоваться от BaseAction или RoleGateHost напрямую.
    """
