...
наследующих BaseParams и BaseResult, в BaseState (состояние конвейера аспектов),
а также в Context-компонентах (UserInfo, RequestInfo, EnvironmentInfo).
...
BaseParams, BaseResult, BaseState. Результаты resolve кешируются лениво
    ...
    def _resolve_step_readable(
        ...
        Аргументы:
            current: объект с ReadableMixin (Context, UserInfo,
                     RequestInfo, EnvironmentInfo, BaseParams,
                     BaseResult, BaseState).
