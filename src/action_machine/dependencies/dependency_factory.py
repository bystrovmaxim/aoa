...
Если менеджер поддерживает rollup (IConnectionManager и наследники),
...
ActionProductMachine получает фабрику через coordinator.get_factory(action.__class__)
и не хранит собственный кеш.
