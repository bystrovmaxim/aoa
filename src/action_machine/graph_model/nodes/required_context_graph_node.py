# src/action_machine/graph_model/nodes/required_context_graph_node.py
"""
...
these nodes originate on :class:`~action_machine.graph_model.nodes.regular_aspect_graph_node.RegularAspectGraphNode`
(analogous to :class:`~action_machine.graph_model.nodes.checker_graph_node.CheckerGraphNode` rows bound via ``_checker_meta``).
