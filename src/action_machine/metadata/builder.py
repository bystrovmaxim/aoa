...
═══════════════════════════════════════════════════════════════════════════════
    ...
    7. Валидация подписок плагинов (validators.validate_subscriptions):
       - event_class из @on совместим с аннотацией параметра event.
    8. Валидация описаний полей (validators.validate_described_fields):
    ...
    9. Конструирование ClassMetadata (frozen dataclass).
═══════════════════════════════════════════════════════════════════════════════
...
наличие OnGateHost) и ПОСЛЕ validate_error_handlers. Это гарантирует,
...
class MetadataBuilder:
    ...
    Порядок валидации:
        ...
        6. validate_subscriptions — совместимость event_class ↔ аннотация event.
        7. validate_described_fields — обязательность описаний полей Params/Result.
    """
