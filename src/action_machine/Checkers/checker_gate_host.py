...
class CheckerGateHost:
    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        ...
        Алгоритм:
            ...
            2. Получает шлюз через get_checker_gate().
            3. Если есть атрибут _field_checkers (список чекеров класса), регистрирует
               каждый чекер с target_type='class'.
            4. Обходит все методы класса, ищет у них атрибут _result_checkers,
