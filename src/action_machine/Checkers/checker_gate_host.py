...
═══════════════════════════════════════════════════════════════════════════════
    ...
    # CheckerGateHostInspector._collect_checkers(cls) scans class methods
...
def require_checker_gate_host_marker(cls: type, checkers: list[Any]) -> None:
    """Есть checkerы → класс должен наследовать CheckerGateHost."""
    if checkers and not issubclass(cls, CheckerGateHost):
        ...
        raise TypeError(
            ...
            f"но не наследует CheckerGateHost. Декораторы checkerов "
