...
:class:`~action_machine.runtime.dependency_factory.DependencyFactory` consumes it.
"""
...
class DependencyInfo:
    ...
    :class:`~action_machine.runtime.dependency_factory.DependencyFactory` reads this tuple during ``ToolsBox`` construction.
