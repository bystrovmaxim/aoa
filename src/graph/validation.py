...
- :class:`action_machine.tools.introspection.TypeIntrospection` — stable type ids use :meth:`~action_machine.tools.introspection.TypeIntrospection.full_qualname`,
