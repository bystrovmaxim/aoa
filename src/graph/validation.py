...
- :class:`action_machine.system_core.type_introspection.TypeIntrospection` — stable type ids use :meth:`~action_machine.system_core.type_introspection.TypeIntrospection.full_qualname`,
