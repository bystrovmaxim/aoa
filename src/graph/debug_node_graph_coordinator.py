# src/graph/debug_node_graph_coordinator.py
"""
...
Builds the same interchange graph as :class:`~graph.node_graph_coordinator.NodeGraphCoordinator`,
...
Do not use this as a production runtime default. :class:`~action_machine.runtime.action_product_machine.ActionProductMachine`
