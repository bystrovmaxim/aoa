...
def test_resolve_domain_type_returns_none_without_meta() -> None:
    assert MetaIntentResolver.resolve_domain_type(_PlainHost) is None
...
def test_resolve_description_returns_none_without_meta() -> None:
    assert MetaIntentResolver.resolve_description(_PlainHost) is None
