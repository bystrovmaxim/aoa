# tests/metadata/test_aspect_gate_host_inspector.py
"""Unit tests for AspectGateHostInspector."""
...
class _NoAspectAction(AspectGateHost):
    pass


class _AspectAction(AspectGateHost):
    @regular_aspect("Step")
...
def test_aspect_inspector_returns_none_without_aspects() -> None:
    assert AspectGateHostInspector.inspect(_NoAspectAction) is None


def test_aspect_inspector_builds_payload_with_aspect_entries() -> None:
    payload = AspectGateHostInspector.inspect(_AspectAction)
