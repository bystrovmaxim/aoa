# tests/metadata/test_subscription_gate_host_inspector.py
"""Unit tests for SubscriptionGateHostInspector."""

from __future__ import annotations

from action_machine.plugins import GlobalFinishEvent, GlobalStartEvent, OnGateHost, on
from action_machine.plugins.subscription_gate_host_inspector import SubscriptionGateHostInspector


class _NoSubscriptionPlugin(OnGateHost):
    pass


class _SubscriptionPlugin(OnGateHost):
    @on(GlobalStartEvent)
...
def test_subscription_inspector_returns_none_without_subscriptions() -> None:
    assert SubscriptionGateHostInspector.inspect(_NoSubscriptionPlugin) is None


def test_subscription_inspector_builds_payload_with_subscriptions() -> None:
    payload = SubscriptionGateHostInspector.inspect(_SubscriptionPlugin)
