# tests/metadata/test_on_error_gate_host_inspector.py
"""Unit tests for OnErrorGateHostInspector."""
...
class _NoOnErrorAction(OnErrorGateHost):
    pass


class _OnErrorAction(OnErrorGateHost):
...
def test_on_error_inspector_returns_none_without_handlers() -> None:
    assert OnErrorGateHostInspector.inspect(_NoOnErrorAction) is None


def test_on_error_inspector_builds_payload_with_handlers() -> None:
    payload = OnErrorGateHostInspector.inspect(_OnErrorAction)
