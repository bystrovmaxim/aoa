...
def test_get_graph_nodes_respects_graph_node_walk_excluded_types() -> None:
    class _R:
        pass
    ...
    class _FilteringInspector(BaseGraphNodeInspector[_R]):
    ...
    assert _FilteringInspector().get_graph_nodes() == [n_root, n_b]


def test_graph_node_walk_excluded_types_skips_root_when_listed() -> None:
    class _R:
        pass
    ...
    class _SkipRootInspector(BaseGraphNodeInspector[_R]):
        def _graph_node_walk_excluded_types(self) -> frozenset[type]:
            return frozenset({_R})
    ...
    assert _SkipRootInspector().get_graph_nodes() == [n_a]
