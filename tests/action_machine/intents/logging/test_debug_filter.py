...
from aoa.action_machine.logging.expression_evaluator import ExpressionEvaluator, _inspect_object
...
from tests.action_machine.scenarios.domain_model.roles import UserRole
