...
"""Golden **G2**: ``logical_test_domain.graph.json`` vs ``get_logical_graph()``."""
...
def test_logical_test_domain_g2_matches_golden() -> None:
...
@pytest.mark.graph_coverage
def test_logical_g2_snapshot_deterministic_across_clean_processes() -> None:
