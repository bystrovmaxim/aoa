# tests/examples/model/test_sample_graph_json_fields.py
"""
Example model interchange graph — ``JsonSchemaValue`` fields on sample ``Result`` models.

═══════════════════════════════════════════════════════════════════════════════
PURPOSE
═══════════════════════════════════════════════════════════════════════════════

After sample modules register actions, :func:`aoa.examples.model.interchange_demo_coordinator.build_registered_interchange_coordinator`
