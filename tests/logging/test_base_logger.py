...
class TestBaseLogger:
    ...
    async def test_handle_without_filters_passes_all(self, recording_logger, scope, context_fixture, params):
        ...
        await logger.handle(scope, "Test message", {}, context_fixture, {}, params, 0)

        assert len(logger.records) == 1
        assert logger.records[0]["message"] == "Test message"
        assert logger.records[0]["scope"] is scope
        assert logger.records[0]["context"] is context_fixture
    ...
    async def test_handle_multiple_calls_without_filters(self, recording_logger, scope, context_fixture, params):
        ...
        await logger.handle(scope, "First", {}, context_fixture, {}, params, 0)
        await logger.handle(scope, "Second", {}, context_fixture, {}, params, 1)
        await logger.handle(scope, "Third", {}, context_fixture, {}, params, 2)
    ...
    async def test_handle_with_matching_filter(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "Hello", {}, context_fixture, {}, params, 0)
    ...
    async def test_handle_filter_checks_var(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "Payment", {"amount": 1500, "user": "john"}, context_fixture, {}, params, 0)
    ...
    async def test_handle_filter_checks_message_text(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "INFO: всё хорошо", {}, context_fixture, {}, params, 0)
        assert len(logger.records) == 0

        await logger.handle(scope, "ERROR: что-то сломалось", {}, context_fixture, {}, params, 0)
        assert len(logger.records) == 1

        await logger.handle(scope, "CRITICAL: система падает", {}, context_fixture, {}, params, 0)
    ...
    async def test_handle_filter_checks_combined_string(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "Processing payment", {"amount": 1500}, context_fixture, {}, params, 0)
        assert len(logger.records) == 1

        await logger.handle(scope, "Processing payment", {"amount": 500}, context_fixture, {}, params, 0)
    ...
    async def test_filter_with_regex_meta_characters(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "Start middle end", {}, context_fixture, {}, params, 0)
        await logger.handle(scope, "Start middle", {}, context_fixture, {}, params, 0)
        await logger.handle(scope, "middle end", {}, context_fixture, {}, params, 0)
    ...
    async def test_filter_with_or_condition(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "I have a cat", {}, context_fixture, {}, params, 0)
        await logger.handle(scope, "I have a dog", {}, context_fixture, {}, params, 0)
        await logger.handle(scope, "I have a bird", {}, context_fixture, {}, params, 0)
    ...
    async def test_handle_passes_all_params_to_write(self, scope, context_fixture, params):
        ...
        assert record["context"] is context_fixture
    ...
    async def test_handle_preserves_var_original(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "test", original_var, context_fixture, {}, params, 0)
    ...
    async def test_handle_with_complex_var_values(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "complex", var, context_fixture, {}, params, 0)
    ...
    async def test_handle_with_empty_filters_list(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "any message", {}, context_fixture, {}, params, 0)
    ...
    async def test_handle_with_empty_message(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "", {}, context_fixture, {}, params, 0)
    ...
    async def test_handle_with_empty_var(self, scope, context_fixture, params):
        ...
        await logger.handle(scope, "test", {}, context_fixture, {}, params, 0)
