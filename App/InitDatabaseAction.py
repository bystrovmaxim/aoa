...
class InitDatabaseAction(BaseTransactionAction):
    ...
    @InstanceOfChecker("tables_created", expected_class=list, desc="Результат _handleAspect: список созданных таблиц")
    @StringFieldChecker("schema", desc="Результат _handleAspect: имя созданной схемы")
