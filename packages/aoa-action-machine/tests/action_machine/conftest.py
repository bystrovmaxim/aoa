# tests/action_machine/conftest.py
"""
Shared fixtures for ``tests/action_machine/`` (and nested subtrees).
...
``tests/action_machine/scenarios/domain_model/``.
...
from ..support.domain_model import OrdersDbManager
