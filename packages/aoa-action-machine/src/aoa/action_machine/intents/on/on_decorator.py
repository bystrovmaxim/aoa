# packages/aoa-action-machine/src/aoa/action_machine/intents/on/on_decorator.py
"""
...
═══════════════════════════════════════════════════════════════════════════════
    ...
    SubscriptionInfo(
        ...
        │
        ▼  :class:`~aoa.action_machine.plugin.plugin.Plugin` collects ``SubscriptionInfo`` from handlers
        │
