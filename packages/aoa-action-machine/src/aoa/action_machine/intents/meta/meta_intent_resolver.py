# packages/aoa-action-machine/src/aoa/action_machine/intents/meta/meta_intent_resolver.py
...
class MetaIntentResolver:
    ...
    FAILURES: :exc:`~aoa.action_machine.exceptions.MissingMetaError` from :meth:`resolve_description` or :meth:`resolve_domain_type` when the required scratch value is absent or invalid.
    AI-CORE-END
    """
