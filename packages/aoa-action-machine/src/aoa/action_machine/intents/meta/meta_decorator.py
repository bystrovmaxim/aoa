# packages/aoa-action-machine/src/aoa/action_machine/intents/meta/meta_decorator.py
"""
...
def meta(
    ...
    *,
    ...
    :class:`~aoa.action_machine.intents.meta.meta_intent_resolver.MetaIntentResolver` and
