...
class CheckRolesIntentResolver:
    ...
    CONTRACT: :meth:`resolve_check_roles` returns stored ``spec`` or raises :exc:`~aoa.action_machine.exceptions.MissingCheckRolesError`; :meth:`resolve_role_mode` reads ``@role_mode``.
    AI-CORE-END
    """
