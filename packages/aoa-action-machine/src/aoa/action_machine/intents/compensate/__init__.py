# packages/aoa-action-machine/src/aoa/action_machine/intents/compensate/__init__.py
"""
...
from aoa.action_machine.intents.compensate.compensate_decorator import compensate
