# packages/aoa-action-machine/src/aoa/action_machine/intents/sensitive/sensitive_intent.py
...
class SensitiveIntent:
    ...
    CONTRACT: Action and schema hierarchies inherit this marker; graph builders read
        ``fget._sensitive_config`` via :class:`~aoa.action_machine.intents.sensitive.sensitive_intent_resolver.SensitiveIntentResolver`.
