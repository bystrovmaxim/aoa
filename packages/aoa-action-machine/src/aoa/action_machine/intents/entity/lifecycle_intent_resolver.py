# packages/aoa-action-machine/src/aoa/action_machine/intents/entity/lifecycle_intent_resolver.py
...
class LifeCycleFiniteAutomaton:
    ...
    Use :attr:`states`: each :class:`~aoa.action_machine.domain.lifecycle.StateInfo`
