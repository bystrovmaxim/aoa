# packages/aoa-action-machine/src/aoa/action_machine/testing/__init__.py
"""
...
- **UserInfoStub** - user stub (defaults: ``user_id="test_user"``,
  ``roles=(StubTesterRole,)`` from ``aoa.action_machine.testing.stubs``).
...
from aoa.action_machine.testing.bench import TestBench
