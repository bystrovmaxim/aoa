# packages/aoa-action-machine/src/aoa/action_machine/exceptions/missing_check_roles_error.py
"""
...
class MissingCheckRolesError(ValueError):
    ...
    CONTRACT: Raised from :meth:`~aoa.action_machine.intents.check_roles.check_roles_intent_resolver.CheckRolesIntentResolver.resolve_check_roles` when storage is absent.
    AI-CORE-END
    """
