# packages/aoa-action-machine/src/aoa/action_machine/exceptions/missing_entity_info_error.py
"""
...
Raised by :class:`~aoa.action_machine.intents.entity.entity_intent_resolver.EntityIntentResolver`
