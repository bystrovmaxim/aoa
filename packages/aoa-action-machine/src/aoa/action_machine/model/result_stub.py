# packages/aoa-action-machine/src/aoa/action_machine/model/result_stub.py
"""
...
:class:`~aoa.action_machine.model.params_stub.ParamsStub` for ``P`` when only the params axis
needs a stub.
"""
