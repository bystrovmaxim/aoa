# packages/aoa-action-machine/src/aoa/action_machine/adapters/base_route_record.py
"""
...
def extract_action_types(action_class: type) -> tuple[type | None, type | None]:
    ...
    Uses :class:`~aoa.action_machine.intents.action_schema.action_schema_intent_resolver.ActionSchemaIntentResolver`
