# packages/aoa-action-machine/src/aoa/action_machine/graph_model/nodes/application_graph_node.py
"""
...
Provides a :class:`~aoa.graph.base_graph_node.BaseGraphNode` view derived from the
...
class is :attr:`~aoa.graph.base_graph_node.BaseGraphNode.node_obj`.
