# packages/aoa-action-machine/src/aoa/action_machine/graph_model/nodes/field_graph_node.py
"""
...
Materializes a frozen :class:`~aoa.graph.base_graph_node.BaseGraphNode` for one logical field under a
...
class FieldGraphPayload:
    """Frozen payload for :attr:`~aoa.graph.base_graph_node.BaseGraphNode.node_obj` (field row metadata only)."""
