# packages/aoa-action-machine/src/aoa/action_machine/graph_model/nodes/summary_aspect_graph_node.py
"""
...
Materializes a frozen :class:`~aoa.graph.base_graph_node.BaseGraphNode` for one summary
...
``@context_requires`` wired as :attr:`required_context` composition edges (:class:`~aoa.action_machine.graph_model.edges.required_context_graph_edge.RequiredContextGraphEdge`).
