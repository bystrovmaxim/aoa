# packages/aoa-action-machine/src/aoa/action_machine/graph_model/nodes/entity_graph_node.py
"""
...
Materializes a frozen :class:`~aoa.graph.base_graph_node.BaseGraphNode` from an
