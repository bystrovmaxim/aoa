# packages/aoa-action-machine/src/aoa/action_machine/graph_model/edges/required_context_graph_edge.py
"""
...
Typed alternative to composing a generic :class:`~aoa.graph.composition_graph_edge.CompositionGraphEdge`
