# packages/aoa-action-machine/src/aoa/action_machine/graph_model/edges/entity_field_graph_edge.py
"""
...
relations excluded); each edge wires the matching :class:`~aoa.action_machine.graph_model.nodes.entity_field_graph_node.EntityFieldGraphNode` as ``target_node``.
"""
