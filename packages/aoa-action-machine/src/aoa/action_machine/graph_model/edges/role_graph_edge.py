# packages/aoa-action-machine/src/aoa/action_machine/graph_model/edges/role_graph_edge.py
"""
...
:class:`~aoa.graph.association_graph_edge.AssociationGraphEdge` semantics (association to declared role classes),
