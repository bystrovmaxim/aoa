# packages/aoa-action-machine/src/aoa/action_machine/graph_model/edges/summary_aspect_graph_edge.py
"""
...
Mirror :meth:`~aoa.action_machine.graph_model.nodes.action_graph_node.ActionGraphNode.get_summary_aspect_graph_node`
