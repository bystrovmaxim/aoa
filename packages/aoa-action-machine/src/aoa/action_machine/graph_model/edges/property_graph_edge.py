# packages/aoa-action-machine/src/aoa/action_machine/graph_model/edges/property_graph_edge.py
"""
...
:class:`~aoa.action_machine.graph_model.nodes.property_field_graph_node.PropertyFieldGraphNode`.
