# packages/aoa-action-machine/src/aoa/action_machine/graph_model/inspectors/resource_graph_node_inspector.py
"""
...
:class:`~aoa.action_machine.graph_model.nodes.resource_graph_node.ResourceGraphNode` per
