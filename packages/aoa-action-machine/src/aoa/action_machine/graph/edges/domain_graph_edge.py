# packages/aoa-action-machine/src/aoa/action_machine/graph/edges/domain_graph_edge.py
"""
...
target is :class:`~aoa.action_machine.graph.nodes.domain_graph_node.DomainGraphNode` (``NODE_TYPE`` ``\"Domain\"``).
