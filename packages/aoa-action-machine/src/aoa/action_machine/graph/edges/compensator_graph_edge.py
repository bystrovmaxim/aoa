# packages/aoa-action-machine/src/aoa/action_machine/graph/edges/compensator_graph_edge.py
"""
...
Mirror :meth:`~aoa.action_machine.graph.edges.compensator_graph_edge.CompensatorGraphEdge.get_compensator_edges`:
