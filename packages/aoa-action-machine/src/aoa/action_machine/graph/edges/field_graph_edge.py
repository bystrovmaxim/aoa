# packages/aoa-action-machine/src/aoa/action_machine/graph/edges/field_graph_edge.py
"""
...
from an interchange graph node to a :class:`~aoa.action_machine.graph.nodes.field_graph_node.FieldGraphNode`.
