# packages/aoa-action-machine/src/aoa/action_machine/graph/edges/sensitive_graph_edge.py
"""
...
Typed composition edge whose ``target_node`` is a :class:`~aoa.action_machine.graph.nodes.sensitive_graph_node.SensitiveGraphNode`
...
from aoa.action_machine.graph.nodes.sensitive_graph_node import SensitiveGraphNode, SensitiveGraphNodeEdgeInfo
