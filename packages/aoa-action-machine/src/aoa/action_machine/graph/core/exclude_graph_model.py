# packages/aoa-action-machine/src/aoa/action_machine/graph/core/exclude_graph_model.py
"""
Opt-out markers for interchange graph row emission (:class:`~aoa.action_machine.graph.core.base_graph_node_inspector.BaseGraphNodeInspector`).
"""
