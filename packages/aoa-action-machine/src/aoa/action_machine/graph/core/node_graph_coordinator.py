# packages/aoa-action-machine/src/aoa/action_machine/graph/core/node_graph_coordinator.py
"""
...
Collects :class:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode` instances from
registered :class:`~aoa.action_machine.graph.core.base_graph_node_inspector.BaseGraphNodeInspector`
**instances** (each implements :meth:`~aoa.action_machine.graph.core.base_graph_node_inspector.BaseGraphNodeInspector.get_graph_nodes`),
validates **unique**
:attr:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode.node_id` keys, **referential
integrity** of :class:`~aoa.action_machine.graph.core.base_graph_edge.BaseGraphEdge.target_node_id`
(for every edge emitted by :meth:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode.get_all_edges`, including
...
with each node's :meth:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode.get_companion_nodes` result
...
from aoa.action_machine.graph.core import _dag
...
class NodeGraphCoordinator:
    ...
    CONTRACT: ``build`` with :class:`~aoa.action_machine.graph.core.base_graph_node_inspector.BaseGraphNodeInspector` instances; each ``get_graph_nodes()``;
    ...
    def get_all_nodes(self) -> tuple[BaseGraphNode[Any], ...]:
        """
        Return every :class:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode` sorted by ``node_id``.
