# packages/aoa-action-machine/src/aoa/action_machine/graph/core/validation.py
"""
Small **invariant checks** for interchange graph models (:class:`~aoa.action_machine.graph.core.base_graph_edge.BaseGraphEdge`,
:class:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode`).
...
- :class:`aoa.action_machine.system_core.type_introspection.TypeIntrospection` — stable type ids use :meth:`~aoa.action_machine.system_core.type_introspection.TypeIntrospection.full_qualname`,
