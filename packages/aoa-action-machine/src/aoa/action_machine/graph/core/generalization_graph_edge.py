# packages/aoa-action-machine/src/aoa/action_machine/graph/core/generalization_graph_edge.py
"""
GeneralizationGraphEdge — UML generalization (inheritance) interchange edge.

Exposes the fixed :data:`~aoa.action_machine.graph.core.edge_relationship.GENERALIZATION` relationship and
...
from aoa.action_machine.graph.core.edge_relationship import GENERALIZATION, EdgeRelationship
