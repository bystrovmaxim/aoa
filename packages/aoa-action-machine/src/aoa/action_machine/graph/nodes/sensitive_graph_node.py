# packages/aoa-action-machine/src/aoa/action_machine/graph/nodes/sensitive_graph_node.py
"""
...
Materializes a frozen :class:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode` for one property
...
``node_id`` uses a ``:sensitive:`` segment so it does not collide with :class:`~aoa.action_machine.graph.nodes.property_field_graph_node.PropertyFieldGraphNode`
