# packages/aoa-action-machine/src/aoa/action_machine/graph/nodes/entity_field_graph_node.py
"""
...
:class:`~aoa.action_machine.graph.nodes.entity_graph_node.EntityGraphNode` via
:class:`~aoa.action_machine.graph.edges.entity_field_graph_edge.EntityFieldGraphEdge`.
