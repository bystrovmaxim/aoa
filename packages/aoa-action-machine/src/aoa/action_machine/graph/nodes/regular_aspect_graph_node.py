# packages/aoa-action-machine/src/aoa/action_machine/graph/nodes/regular_aspect_graph_node.py
"""
...
:meth:`~aoa.action_machine.intents.aspects.regular_aspect_intent_resolver.RegularAspectIntentResolver.resolve_description`
