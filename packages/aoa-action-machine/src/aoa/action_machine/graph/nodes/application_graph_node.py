# packages/aoa-action-machine/src/aoa/action_machine/graph/nodes/application_graph_node.py
"""
ApplicationGraphNode — interchange node for :class:`~aoa.action_machine.application.application.Application`.

═══════════════════════════════════════════════════════════════════════════════
PURPOSE
═══════════════════════════════════════════════════════════════════════════════

Provides a :class:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode` view derived from the
...
class is :attr:`~aoa.action_machine.graph.core.base_graph_node.BaseGraphNode.node_obj`.
