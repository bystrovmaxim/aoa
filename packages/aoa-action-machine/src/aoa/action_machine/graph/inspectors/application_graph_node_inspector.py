# packages/aoa-action-machine/src/aoa/action_machine/graph/inspectors/application_graph_node_inspector.py
"""
...
out via :class:`~aoa.action_machine.graph.core.exclude_graph_model.exclude_graph_model`.
