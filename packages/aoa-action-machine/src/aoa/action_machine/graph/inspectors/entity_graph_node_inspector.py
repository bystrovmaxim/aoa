# packages/aoa-action-machine/src/aoa/action_machine/graph/inspectors/entity_graph_node_inspector.py
"""
...
:class:`~aoa.action_machine.graph.core.exclude_graph_model.exclude_graph_model`
(see :meth:`~aoa.action_machine.graph.core.base_graph_node_inspector.BaseGraphNodeInspector.get_graph_nodes`).
