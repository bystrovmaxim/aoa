# packages/aoa-demo/src/aoa/demo/fastapi_mcp_services/app_mcp_service.py
"""
...
Running the script by path works too::
    ...
    python /path/to/aoa/packages/aoa-demo/src/aoa/demo/fastapi_mcp_services/app_mcp_service.py
