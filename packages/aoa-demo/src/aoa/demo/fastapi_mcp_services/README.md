<p align="center">
  ...
  <img src="https://img.shields.io/badge/extras-fastapi%20·%20mcp-lightgrey" alt="aoa-demo[fastapi,mcp]">
  <a href="../../../../README.md"><img src="https://img.shields.io/badge/docs-aoa--examples-blue" alt="aoa-demo"></a>
</p>
...
python -m aoa.demo.fastapi_mcp_services.app_mcp_service

# Via streamable-http (MCP Inspector):
python -m aoa.demo.fastapi_mcp_services.app_mcp_service --transport streamable-http
```
...
```json
{
  "mcpServers": {
    "orders": {
      "command": "python",
      "args": ["-m", "aoa.demo.fastapi_mcp_services.app_mcp_service"]
    }
  }
}
```
...
```bash
claude mcp add orders -- python -m aoa.demo.fastapi_mcp_services.app_mcp_service
```
