# packages/aoa-demo/src/aoa/demo/model/store/actions/store_read.py
...
from aoa.demo.model.roles import ViewerRole
...
class StoreReadAction(BaseAction["StoreReadAction.Params", "StoreReadAction.Result"]):
    ...
    concrete reads like :class:`~aoa.demo.model.store.actions.order_lookup.OrderLookupAction`
