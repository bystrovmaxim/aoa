# packages/aoa-demo/src/aoa/demo/model/store/entities/sales_core.py
"""
...
:class:`~aoa.action_machine.domain.relation_markers.Inverse` captures partner types at class-body time,
