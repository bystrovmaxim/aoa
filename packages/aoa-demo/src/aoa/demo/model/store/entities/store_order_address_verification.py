# packages/aoa-demo/src/aoa/demo/model/store/entities/store_order_address_verification.py
...
from aoa.demo.model.store.entities.sales_core import CustomerAccountEntity
