# packages/aoa-demo/src/aoa/demo/model/store/entities/store_line_shipment_piece.py
...
from aoa.demo.model.store.entities.sales_core import SalesOrderEntity, SalesOrderLineEntity
