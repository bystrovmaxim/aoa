# packages/aoa-demo/src/aoa/demo/model/store/entities/sales_order_lifecycle.py
...
class SalesOrderLifecycle(Lifecycle):
    ...
    _template = (
        Lifecycle()
        .state("new", "New")
        .to("payment_pending", "cancelled")
        .initial()
        .state("payment_pending", "Payment pending")
        .to("confirmed", "cancelled")
        .intermediate()
        .state("confirmed", "Confirmed")
        .to("pending_fulfillment", "rework")
        .intermediate()
        .state("rework", "Rework")
        .to("confirmed")
        .intermediate()
        .state("pending_fulfillment", "Pending fulfillment")
        .to("shipped")
        .intermediate()
