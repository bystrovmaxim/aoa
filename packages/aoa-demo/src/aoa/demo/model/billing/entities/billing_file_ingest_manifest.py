# packages/aoa-demo/src/aoa/demo/model/billing/entities/billing_file_ingest_manifest.py
...
from aoa.demo.model.billing.entities.billing_dense_lifecycle import BillingPipelineLifecycle
