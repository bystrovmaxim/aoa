# packages/aoa-demo/src/aoa/demo/model/billing/actions/invoice_settle.py
...
from aoa.demo.model.billing.resources import BillingReadReplica, BillingWarehouse
