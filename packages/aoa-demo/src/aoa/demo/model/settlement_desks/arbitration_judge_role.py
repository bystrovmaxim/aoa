# packages/aoa-demo/src/aoa/demo/model/settlement_desks/arbitration_judge_role.py
...
from aoa.demo.model.settlement_desks.regional_desk_lead_role import RegionalDeskLeadRole
