# packages/aoa-demo/src/aoa/demo/model/catalog_custody/actions/custody_workbench_merge_action.py
...
from aoa.demo.model.catalog_custody.catalog_officer_role import CatalogOfficerRole
