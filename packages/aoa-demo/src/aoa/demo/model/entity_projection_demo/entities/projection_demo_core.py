# packages/aoa-demo/src/aoa/demo/model/entity_projection_demo/entities/projection_demo_core.py
"""
...
from aoa.demo.model.entity_projection_demo.entities.projection_demo_lifecycle import (
