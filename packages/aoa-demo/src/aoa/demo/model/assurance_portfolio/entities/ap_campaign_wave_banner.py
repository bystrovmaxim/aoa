# packages/aoa-demo/src/aoa/demo/model/assurance_portfolio/entities/ap_campaign_wave_banner.py
...
@entity(description="Execution wave facade (test_plan analogue)", domain=AssurancePortfolioDomain)
