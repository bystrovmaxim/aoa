# packages/aoa-demo/src/aoa/demo/model/assurance_portfolio/entities/ap_facility_actor.py
...
from aoa.demo.model.assurance_portfolio.entities.ap_reference_axes import AssuranceAccountPhaseAxisEntity
