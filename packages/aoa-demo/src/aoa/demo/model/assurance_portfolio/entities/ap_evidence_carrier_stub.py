# packages/aoa-demo/src/aoa/demo/model/assurance_portfolio/entities/ap_evidence_carrier_stub.py
...
from aoa.demo.model.assurance_portfolio.entities.ap_reference_axes import AssuranceEvidenceKindAxisEntity
