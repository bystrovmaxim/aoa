# packages/aoa-demo/src/aoa/demo/model/assurance_portfolio/entities/ap_expectation_outline_node.py
...
from aoa.demo.model.assurance_portfolio.entities.ap_reference_axes import AssuranceSpecificationDepthAxisEntity
