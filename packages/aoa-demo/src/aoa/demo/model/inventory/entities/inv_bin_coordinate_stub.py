# packages/aoa-demo/src/aoa/demo/model/inventory/entities/inv_bin_coordinate_stub.py
...
from aoa.demo.model.inventory.entities.inv_dense_lifecycle import InvPipelineLifecycle
