# packages/aoa-demo/src/aoa/demo/model/catalog/actions/product_enrichment.py
...
from aoa.demo.model.catalog.resources import CatalogObjectStore, CatalogSearchSidecar
