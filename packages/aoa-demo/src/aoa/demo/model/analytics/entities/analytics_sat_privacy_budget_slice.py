# packages/aoa-demo/src/aoa/demo/model/analytics/entities/analytics_sat_privacy_budget_slice.py
...
from aoa.demo.model.analytics.entities.an_dense_lifecycle import AnalyticsFactLifecycle
