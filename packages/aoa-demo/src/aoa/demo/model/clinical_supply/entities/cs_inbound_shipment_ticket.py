# packages/aoa-demo/src/aoa/demo/model/clinical_supply/entities/cs_inbound_shipment_ticket.py
...
from aoa.demo.model.clinical_supply.domain import ClinicalSupplyDomain
