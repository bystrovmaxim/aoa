# packages/aoa-demo/src/aoa/demo/model/logistics_mesh/gate_dispatch_lead_role.py
...
from aoa.demo.model.logistics_mesh.yard_operations_specialist_role import YardOperationsSpecialistRole
