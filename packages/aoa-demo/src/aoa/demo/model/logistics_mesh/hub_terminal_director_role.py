# packages/aoa-demo/src/aoa/demo/model/logistics_mesh/hub_terminal_director_role.py
...
from aoa.demo.model.logistics_mesh.gate_dispatch_lead_role import GateDispatchLeadRole
