# packages/aoa-demo/src/aoa/demo/model/messaging/entities/msg_webhook_signature_envelope.py
...
from aoa.demo.model.messaging.entities.msg_dense_lifecycle import MsgWebhookLifecycle
