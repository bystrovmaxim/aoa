# packages/aoa-demo/src/aoa/demo/model/messaging/entities/msg_dispatcher_cursor_shard.py
...
from aoa.demo.model.messaging.entities.msg_dense_lifecycle import MsgDenseLifecycle
