# packages/aoa-demo/src/aoa/demo/model/messaging/actions/publish_transactional.py
...
from aoa.demo.model.messaging.resources import MessagingDeadLetterStore, OutboxPrimaryDatabase
