...
async def test_check_access_decide_matches_run_semantics(machine: ActionProductMachine) -> None:
    ...
    assert own == AccessVerdict(allowed=True, action=CancelOrderAction, level=None, reason=None)
