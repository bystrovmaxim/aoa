# packages/aoa-examples/src/aoa/examples/fastapi_mcp_services/app_fastapi_service.py
"""
...
═══════════════════════════════════════════════════════════════════════════════
    ...
    Same module starts uvicorn when run as a file::
        ...
        python …/packages/aoa-examples/src/aoa/examples/fastapi_mcp_services/app_fastapi_service.py
