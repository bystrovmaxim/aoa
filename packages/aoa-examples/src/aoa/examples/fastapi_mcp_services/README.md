...
```bash
uvicorn aoa.examples.fastapi_mcp_services.app_fastapi_service:app --reload
```
...
```bash
claude mcp add orders -- python -m aoa.examples.fastapi_mcp_services.app_mcp_service
```
