# packages/aoa-examples/src/aoa/examples/fastapi_mcp_services/app_mcp_service.py
"""
...
Install and run::
    ...
    python -m aoa.examples.fastapi_mcp_services.app_mcp_service

    # streamable-http (e.g. MCP Inspector):
    python -m aoa.examples.fastapi_mcp_services.app_mcp_service --transport streamable-http

Running the script by path works too::

    python /path/to/aoa/packages/aoa-examples/src/aoa/examples/fastapi_mcp_services/app_mcp_service.py
Claude Desktop ``claude_desktop_config.json``::

    {
      "mcpServers": {
        "orders": {
          "command": "python",
          "args": ["-m", "aoa.examples.fastapi_mcp_services.app_mcp_service"]
        }
      }
    }
