# packages/aoa-examples/src/aoa/examples/model/messaging/entities/msg_dispatcher_cursor_shard.py
...
from aoa.examples.model.messaging.entities.msg_dense_lifecycle import MsgDenseLifecycle
