# packages/aoa-examples/src/aoa/examples/model/messaging/entities/msg_webhook_signature_envelope.py
...
from aoa.examples.model.messaging.entities.msg_dense_lifecycle import MsgWebhookLifecycle
