# packages/aoa-examples/src/aoa/examples/model/catalog_custody/catalog_officer_role.py
...
from aoa.examples.model.catalog_custody.custody_access_steward_role import CustodyAccessStewardRole
