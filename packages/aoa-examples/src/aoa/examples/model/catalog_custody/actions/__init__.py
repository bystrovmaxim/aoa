# packages/aoa-examples/src/aoa/examples/model/catalog_custody/actions/__init__.py
from __future__ import annotations

from aoa.examples.model.catalog_custody.actions.custody_workbench_merge_action import CustodyWorkbenchMergeAction
