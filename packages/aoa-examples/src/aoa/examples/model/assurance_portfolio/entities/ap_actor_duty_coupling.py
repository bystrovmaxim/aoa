# packages/aoa-examples/src/aoa/examples/model/assurance_portfolio/entities/ap_actor_duty_coupling.py
...
from aoa.examples.model.assurance_portfolio.entities.ap_reference_axes import AssuranceDutyTemplateAxisEntity
