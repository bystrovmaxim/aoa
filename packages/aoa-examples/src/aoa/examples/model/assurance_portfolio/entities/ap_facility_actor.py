# packages/aoa-examples/src/aoa/examples/model/assurance_portfolio/entities/ap_facility_actor.py
...
from aoa.examples.model.assurance_portfolio.entities.ap_reference_axes import AssuranceAccountPhaseAxisEntity
