# packages/aoa-examples/src/aoa/examples/model/identity/entities/identity_credential_rotation_stub.py
...
from aoa.examples.model.identity.domain import IdentityDomain
