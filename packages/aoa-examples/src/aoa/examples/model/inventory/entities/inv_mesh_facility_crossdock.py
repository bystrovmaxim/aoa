# packages/aoa-examples/src/aoa/examples/model/inventory/entities/inv_mesh_facility_crossdock.py
...
from aoa.examples.model.inventory.domain import InventoryDomain
from aoa.examples.model.inventory.entities.inv_crossdock_staging import CrossDockStagingEntity
from aoa.examples.model.inventory.entities.inv_dense_lifecycle import InvDenseLifecycle
