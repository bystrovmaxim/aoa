# packages/aoa-examples/src/aoa/examples/model/catalog/actions/product_enrichment.py
...
from aoa.examples.model.catalog.resources import CatalogObjectStore, CatalogSearchSidecar
