# packages/aoa-examples/src/aoa/examples/model/logistics_mesh/yard_operations_specialist_role.py
...
from aoa.examples.model.logistics_mesh.dock_floor_associate_role import DockFloorAssociateRole
