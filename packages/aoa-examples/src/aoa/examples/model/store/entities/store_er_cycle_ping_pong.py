# packages/aoa-examples/src/aoa/examples/model/store/entities/store_er_cycle_ping_pong.py
"""
...
into :class:`~aoa.examples.model.store.entities.sales_core.CustomerAccountEntity` and
:class:`~aoa.examples.model.store.entities.sales_core.SalesOrderEntity` merge the subgraph with
