# packages/aoa-examples/src/aoa/examples/model/services/graph_json_service.py
"""
...
from aoa.examples.model.interchange_demo_coordinator import build_registered_interchange_coordinator
