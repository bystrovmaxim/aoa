# packages/aoa-examples/src/aoa/examples/model/telemetry_pipeline/normalization_lane_owner_role.py
...
from aoa.examples.model.telemetry_pipeline.collector_channel_owner_role import CollectorChannelOwnerRole
