# packages/aoa-examples/src/aoa/examples/model/telemetry_pipeline/incident_observability_director_role.py
...
from aoa.examples.model.telemetry_pipeline.correlation_lane_owner_role import CorrelationLaneOwnerRole
