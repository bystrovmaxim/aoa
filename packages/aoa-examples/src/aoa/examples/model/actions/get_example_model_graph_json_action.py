# packages/aoa-examples/src/aoa/examples/model/actions/get_example_model_graph_json_action.py
"""
...
from aoa.examples.model.graph_json_domain import ExampleModelGraphJsonDomain
