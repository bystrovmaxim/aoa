# packages/aoa-examples/src/aoa/examples/model/billing/actions/invoice_settle.py
...
from aoa.examples.model.billing.resources import BillingReadReplica, BillingWarehouse
