# packages/aoa-examples/src/aoa/examples/model/billing/entities/billing_sat_interchange_slice.py
...
from aoa.examples.model.billing.entities.billing_dense_lifecycle import BillingDenseLifecycle

if TYPE_CHECKING:
    from aoa.examples.model.billing.entities.billing_mesh_chargeback_ingest import (
