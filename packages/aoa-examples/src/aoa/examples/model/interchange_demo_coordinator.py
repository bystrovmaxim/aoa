# packages/aoa-examples/src/aoa/examples/model/interchange_demo_coordinator.py
"""
...
def import_sample_registration_modules() -> None:
    """Import same modules as ``aoa.examples.model.build`` for registration side effects."""
    if _pytest_demo_cache_enabled() and _demo_pytest_cache.modules_done:
        return
    from aoa.examples.model.build import _MODULES  # pylint: disable=import-outside-toplevel
