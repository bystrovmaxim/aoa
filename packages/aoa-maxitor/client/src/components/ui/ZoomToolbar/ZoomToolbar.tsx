  ...
  return (
    ...
    >
      <Box sx={{ display: "flex", alignItems: "center", gap: "2px" }}>
        <Button variant="text" disableRipple onClick={onZoomIn} aria-label="Zoom in" sx={ZOOM_BTN_SX}>
          +
        </Button>
        <Button variant="text" disableRipple onClick={onZoomOut} aria-label="Zoom out" sx={ZOOM_BTN_SX}>
          −
        </Button>
        <Button variant="text" disableRipple onClick={onFit} aria-label="Fit to window" sx={ZOOM_BTN_SX}>
          ⊡
        </Button>
        <Typography
          component="span"
