// packages/aoa-maxitor/client/src/features/diagrams/erd/lib/build_erd_html_document.ts
/**
...
import { enrichErdDataForViewer } from "./enrich_erd_data";
...
export function buildErdHtmlDocument(erdData: Record<string, unknown>, title: string): string {
  ...
  if (!bootstrap.includes(ERD_BOOTSTRAP_PLACEHOLDER)) {
    throw new Error("erd/shell/erd_bootstrap.js is missing __MAXITOR_ERD_DATA_JSON__");
  }
