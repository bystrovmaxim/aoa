# packages/aoa-maxitor/src/aoa/maxitor/samples/store/entities/store_order_address_verification.py
...
from aoa.maxitor.samples.store.entities.sales_core import CustomerAccountEntity
