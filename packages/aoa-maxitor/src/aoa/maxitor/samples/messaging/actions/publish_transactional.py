# packages/aoa-maxitor/src/aoa/maxitor/samples/messaging/actions/publish_transactional.py
...
from aoa.maxitor.samples.messaging.resources import MessagingDeadLetterStore, OutboxPrimaryDatabase
