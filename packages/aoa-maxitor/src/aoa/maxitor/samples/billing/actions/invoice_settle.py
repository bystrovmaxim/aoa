# packages/aoa-maxitor/src/aoa/maxitor/samples/billing/actions/invoice_settle.py
...
from aoa.maxitor.samples.billing.resources import BillingReadReplica, BillingWarehouse
