# packages/aoa-maxitor/src/aoa/maxitor/samples/billing/__init__.py
"""
...
from aoa.maxitor.samples.billing.entities import PaymentEventLogEntity
from aoa.maxitor.samples.billing.resources.payment_gateway import PaymentGateway
