# packages/aoa-maxitor/src/aoa/maxitor/samples/billing/entities/billing_file_ingest_manifest.py
...
from aoa.maxitor.samples.billing.entities.billing_dense_lifecycle import BillingPipelineLifecycle
