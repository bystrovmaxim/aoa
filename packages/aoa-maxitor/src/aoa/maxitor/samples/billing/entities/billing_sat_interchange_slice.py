# packages/aoa-maxitor/src/aoa/maxitor/samples/billing/entities/billing_sat_interchange_slice.py
...
if TYPE_CHECKING:
    from aoa.maxitor.samples.billing.entities.billing_mesh_chargeback_ingest import (
