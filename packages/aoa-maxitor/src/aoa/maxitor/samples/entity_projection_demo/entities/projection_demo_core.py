# packages/aoa-maxitor/src/aoa/maxitor/samples/entity_projection_demo/entities/projection_demo_core.py
"""
...
from aoa.maxitor.samples.entity_projection_demo.entities.projection_demo_lifecycle import (
