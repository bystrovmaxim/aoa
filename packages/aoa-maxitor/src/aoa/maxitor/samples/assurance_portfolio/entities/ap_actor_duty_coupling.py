# packages/aoa-maxitor/src/aoa/maxitor/samples/assurance_portfolio/entities/ap_actor_duty_coupling.py
...
from aoa.maxitor.samples.assurance_portfolio.entities.ap_reference_axes import AssuranceDutyTemplateAxisEntity
