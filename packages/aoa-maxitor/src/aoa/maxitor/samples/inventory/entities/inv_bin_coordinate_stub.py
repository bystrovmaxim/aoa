# packages/aoa-maxitor/src/aoa/maxitor/samples/inventory/entities/inv_bin_coordinate_stub.py
...
from aoa.maxitor.samples.inventory.entities.inv_dense_lifecycle import InvPipelineLifecycle
