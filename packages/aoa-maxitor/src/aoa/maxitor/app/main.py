# packages/aoa-maxitor/src/aoa/maxitor/app/main.py
"""CLI entry for ``python -m aoa.maxitor.app.main`` and the ``maxitor-flet`` script."""
...
def run() -> None:
    ...
    from aoa.maxitor.app.shell import main
