# packages/aoa-maxitor/src/aoa/maxitor/app/shell.py
"""
...
Run: ``python -m aoa.maxitor.app.main``.
"""
...
from aoa.maxitor.app.components import LeftSidebar
from aoa.maxitor.app.diagrams.erd import write_erd_html_from_coordinator
from aoa.maxitor.app.diagrams.graph import generate_interchange_g6_html
...
async def main(page: ft.Page, sidebar_data: Any) -> None:
    ...
    if page.web:
        page.add(ft.Text("Desktop only: python -m aoa.maxitor.app.main", selectable=True))
        return
