# packages/aoa-maxitor/src/aoa/maxitor/app/diagrams/graph/domain_propagation.py
"""
...
:mod:`~aoa.maxitor.app.diagrams.graph.component` so the large HTML exporter stays within
