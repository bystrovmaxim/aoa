# packages/aoa-maxitor/src/aoa/maxitor/diagrams/resources/icons.py
"""
...
on colored node disks, and by the ERD HTML builder (:mod:`aoa.maxitor.diagrams.erd.html_page`)
...
:class:`~aoa.action_machine.graph_model.nodes.params_graph_node.ParamsGraphNode`, :class:`~aoa.action_machine.graph_model.nodes.result_graph_node.ResultGraphNode`,
:class:`~aoa.action_machine.graph_model.nodes.field_graph_node.FieldGraphNode`, :class:`~aoa.action_machine.graph_model.nodes.property_field_graph_node.PropertyFieldGraphNode`,
:class:`~aoa.action_machine.graph_model.nodes.entity_graph_node.EntityGraphNode`, :class:`~aoa.action_machine.graph_model.nodes.lifecycle_graph_node.LifeCycleGraphNode`, :class:`~aoa.action_machine.graph_model.nodes.application_graph_node.ApplicationGraphNode`,
:class:`~aoa.action_machine.graph_model.nodes.domain_graph_node.DomainGraphNode`,
:class:`~aoa.action_machine.graph_model.nodes.resource_graph_node.ResourceGraphNode`,
:class:`~aoa.action_machine.graph_model.nodes.required_context_graph_node.RequiredContextGraphNode`,
:class:`~aoa.action_machine.graph_model.nodes.role_graph_node.RoleGraphNode`,
and :class:`~aoa.action_machine.graph_model.nodes.sensitive_graph_node.SensitiveGraphNode`. Other keys are interchange-only strings without a matching graph-node ``NODE_TYPE`` (for example lifecycle state labels).
"""
