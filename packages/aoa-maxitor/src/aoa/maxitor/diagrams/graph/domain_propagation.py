# packages/aoa-maxitor/src/aoa/maxitor/diagrams/graph/domain_propagation.py
"""
...
:mod:`~aoa.maxitor.diagrams.graph.html_page` so the large HTML exporter stays within
