# packages/aoa-maxitor/src/aoa/maxitor/diagrams/erd/html_page.py
# mypy: ignore-errors
...
from aoa.maxitor.diagrams.resources.icons import svg_data_uri_for_interchange_domain_legend
...
// ════════════════════════════════════════════════════════════════════════════
//  ERD Viewer Bootstrap  —  injected by html_page.py
// ════════════════════════════════════════════════════════════════════════════
...
# ── Domain panel accents (post-serialization on erd_data dict) ────────────────
...
def erd_html_string(
    ...
    *,
    ...
    """Return standalone ERD HTML (no filesystem I/O)."""
