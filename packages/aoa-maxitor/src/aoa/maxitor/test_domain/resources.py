# packages/aoa-maxitor/src/aoa/maxitor/test_domain/resources.py
"""
Runnable stub: prints the test-domain resource manager class used with ``@depends`` / ``@connection``.

Usage (from repo root, venv active)::

    python packages/aoa-maxitor/src/aoa/maxitor/test_domain/resources.py
...
def main() -> None:
    ...
    from tests.action_machine.scenarios.domain_model.test_db_manager import (  # pylint: disable=import-error,import-outside-toplevel
        OrdersDbManager,
    )
