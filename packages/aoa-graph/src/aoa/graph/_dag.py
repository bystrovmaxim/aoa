# packages/aoa-graph/src/aoa/graph/_dag.py
...
Pure-Python checks used by :class:`~aoa.graph.node_graph_coordinator.NodeGraphCoordinator`
and :class:`~aoa.graph.debug_node_graph_coordinator.DebugNodeGraphCoordinator`: whether the
