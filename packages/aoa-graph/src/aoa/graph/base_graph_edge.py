# packages/aoa-graph/src/aoa/graph/base_graph_edge.py
"""
...
:class:`~aoa.graph.base_graph_node.BaseGraphNode` for **target**, and **properties**
...
from aoa.graph.edge_relationship import EdgeRelationship
from aoa.graph.validation import require_non_empty_str
