# packages/aoa-graph/src/aoa/graph/validation.py
"""
Small **invariant checks** for interchange graph models (:class:`~aoa.graph.base_graph_edge.BaseGraphEdge`,
:class:`~aoa.graph.base_graph_node.BaseGraphNode`).
