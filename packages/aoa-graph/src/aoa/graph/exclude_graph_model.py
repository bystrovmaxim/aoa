# packages/aoa-graph/src/aoa/graph/exclude_graph_model.py
"""
Opt-out markers for interchange graph row emission (:class:`~aoa.graph.base_graph_node_inspector.BaseGraphNodeInspector`).
"""
