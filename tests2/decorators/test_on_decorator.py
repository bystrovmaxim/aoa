# tests2/plugins/test_on_decorator.py
"""
...
is a non-empty string, and that action_filter is a string.

Scenarios covered:
    - Valid async method with 4 params is decorated without error.
...
class TestValidUsage:
    ...
    def test_decorates_valid_method(self) -> None:
        """A valid async method with 4 params is decorated without error."""
    ...
    def test_subscription_info_event_type(self) -> None:
        ...
        info = handler._on_subscriptions[0]
    ...
    def test_multiple_subscriptions(self) -> None:
        ...
        assert len(handler._on_subscriptions) == 2
        event_types = {s.event_type for s in handler._on_subscriptions}
    ...
    def test_returns_original_function(self) -> None:
        ...
        decorated = on("global_finish")(handler)
