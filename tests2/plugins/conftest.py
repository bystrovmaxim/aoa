...
через @on — и pytest-фикстуры, специфичные для пакета tests2/plugins/.

Тестовые плагины определяются здесь, а не в tests2/domain/, потому что
...
из tests2/conftest.py. Этот файл дополняет их фикстурами для плагинов.
